...
const translations = {
  en: {
    ...
    'bike-rent-bike-available': 'Available bikes',
    'bike-rent-dock-available': 'Available docks',
    'bike-rent-ebike-available': 'Available electrical bikes',
    'bike-rent-station-id': 'Station ID',
    ...
    'location-work': 'Work',
    login: 'Log in',
    'long-distance-lines': 'Long distance lines',
    ...
    'print-timetable-plan': 'Weekly timetable',
    provider: 'Estonian Transport Adminstration',
    ...
    'route-type-train': 'Train',
    'route-type-city-line-bus': 'City line (Bus)',
    'route-type-city-line-tram': 'City line (Tram)',
    'route-type-city-line-trolley': 'City line (Trolley)',
    'route-type-city-line-commercial': 'City line (Commercial)',
    'route-type-regional-line-pso': 'Regional line (PSO)',
    'route-type-regional-line-commercial': 'Regional line (Commercial)',
    'route-type-long-distance-bus-line': 'Long Distance Bus line',
    'route-type-ferry': 'Ferry',
    routes: 'Routes',
    ...
    spots: 'Locations',
    stop: 'Stop',
    'stop-does-not-exist': 'Stop does not exist',
    ...
    'timetable-valid-till': 'The timetable is valid until:',
    'timetable-valid-from': 'The timetable is valid from:',
  ...
  et: {
    ...
    'add-via-button-label': 'Lisa vahepunkt',
    address: 'Aadress',
    ...
    'bike-rent-bike-available': 'Vabad rattad',
    'bike-rent-dock-available': 'Vabad kohad',
    'bike-rent-ebike-available': 'Vabad elektrirattad',
    'bike-rent-station-id': 'Parkla ID',
    ...
    cause: 'põhjus',
    'char-left': 'märki',
    charging_station: 'Laadimispunkt',
    ...
    'clear-button-label': 'Tühjenda',
    close: 'Sulge',
    'contact-information': '{contactName} kontakti detailid',
    continue: 'Jätka',
    'county-lines': 'Maakonnaliinid',
    ...
    'location-work': 'Töö',
    login: 'Logi sisse',
    'long-distance-lines': 'Kaugliinid',
    'long-transfers-margin': '12 min',
    ...
    'map-layer-amenities': 'Huvipunktid',
    'map-layer-park-and-ride': 'Rattaparklad',
    ...
    'print-timetable-plan': 'Koondplaan',
    provider: 'Transpordiamet',
    ...
    'route-type-train': 'Rong',
    'route-type-city-line-bus': 'Linnaliin (buss)',
    'route-type-city-line-tram': 'Linnaliin (tramm)',
    'route-type-city-line-trolley': 'Linnaliin (troll)',
    'route-type-city-line-commercial': 'Linnaliin (kommerts)',
    'route-type-regional-line-pso': 'Maakonnaliin (avalik)',
    'route-type-regional-line-commercial': 'Maakonnaliin (kommerts)',
    'route-type-long-distance-bus-line': 'Kaugliin',
    'route-type-ferry': 'Laev',
    routes: 'Liinid',
    'routes-platforms': 'Liinid',
    run: 'Käivita',
    save: 'Salvesta',
    search: 'Otsi',
    'search-button-label': 'Otsi',
    'search-destination': 'Otsi sihtkohta, liini või peatust',
    'search-destination-results-but-no-search':
    ...
    send: 'Saada',
    'service-manager': 'Korraldaja:',
    'service-operator': 'Vedaja:',
    settings: 'Seaded',
    ...
    spots: 'Asukohad',
    stop: 'Peatus',
    'stop-does-not-exist': 'Peatust ei eksisteeri',
    ...
    'swap-order-button-label': 'Vaheta lähte- ja sihtkoht',
    taxi: 'Takso',
    'terminal-page.description': 'Terminal {name}',
    'terminal-page.title': 'Terminal {name}',
    'terminal-page.title-short': 'Terminal',
    ...
    'timetable-summary': 'Koondsõiduplaan',
    'timetable-valid-till': 'Sõiduplaan kehtib kuni:',
    'timetable-valid-from': 'Sõiduplaan kehtib alates:',
    timetables: 'Sõiduplaanid',
    'to-stop': 'Kaugus',
    today: 'Täna',
    tomorrow: 'Homme',
    'train-lines': 'Rongiliinid',
    tram: 'Tramm',
    ...
    'bike-rent-bike-available': 'Vapaat pyörät',
    'bike-rent-dock-available': 'Vapaat paikat',
    'bike-rent-ebike-available': 'Vapaa sähköinen pyörät',
    'bike-rent-station-id': 'Pysäköinti ID',
    ...
    'long-distance-lines': 'Pitkän matkan linjat',
    'long-transfers-margin': '12 min',
    ...
    'print-timetable-plan': 'Viikkoaikataulu',
    provider: 'Estonian Transport Adminstration',
    ...
    'route-type-train': 'Juna',
    'route-type-city-line-bus': 'Kaupunki linja (bussi)',
    'route-type-city-line-tram': 'Kaupunki linja (raitiovaunu)',
    'route-type-city-line-trolley': 'Kaupunki linja (vaunu)',
    'route-type-city-line-commercial': 'Kaupunki linja',
    'route-type-regional-line-pso': 'Seutuliikenne (PSO)',
    'route-type-regional-line-commercial': 'Seutuliikenne',
    'route-type-long-distance-bus-line': 'Kaukoliikenne (Commercial)',
    'route-type-ferry': 'Lautaliikenne',
    routes: 'Linjat',
    ...
    send: 'Lähetä',
    'service-manager': 'Järjestäjä:',
    'service-operator': 'Kuljettaja:',
    settings: 'Asetukset',
    ...
    spots: 'Sijainnit',
    stop: 'Pysäkki',
    'stop-does-not-exist': 'Pysäkki ei ole olemassa',
    ...
    time: 'Aika',
    timetable: 'Aikataulu',
    'timetable-valid-till': 'Aikataulu on voimassa asti:',
    'timetable-valid-from': 'Aikataulu on voimassa alkaen:',
    timetables: 'Aikataulut',
    'to-stop': 'Pysäkille',
    today: 'Tänään',
    tomorrow: 'Huomenna',
    'train-lines': 'Juna linijat',
    tram: 'Raitiovaunu',
  ...
  ru: {
    ...
    'bike-rent-bike-available': 'Свободные велосипеды',
    'bike-rent-dock-available': 'Свободные места',
    'bike-rent-ebike-available': 'Свободные электровелосипеды',
    'bike-rent-station-id': 'ID станции',
    ...
    continue: 'Продолжить',
    'county-lines': 'Pегиональные линии',
    ...
    login: 'Авторизуйся',
    'long-distance-lines': 'Mеждугородние линии',
    ...
    map: 'Карта',
    'map-layer-citybike': 'Станции велопроката',
    'map-layer-amenities': 'Точки интереса',
    ...
    'print-timetable-plan': 'Расписание на неделю',
    provider: 'Департамент транспорта Эстонии',
    ...
    'route-type-train': 'Поезд',
    'route-type-city-line-bus': 'Городские маршруты (автобус)',
    'route-type-city-line-tram': 'Городские маршруты (трамвай)',
    'route-type-city-line-trolley': 'Городские маршруты (троллейбус)',
    'route-type-city-line-commercial': 'Городские маршруты (коммерческие)',
    'route-type-regional-line-pso': 'Региональные маршруты (субсидируемые)',
    'route-type-regional-line-commercial': 'Региональные маршруты (коммерческие)',
    'route-type-long-distance-bus-line': 'Междугородние маршруты',
    'route-type-ferry': 'Паром',
    routes: 'Маршруты',
    ...
    send: 'Отправить',
    'service-manager': 'Заказчик перевозок:',
    'service-operator': 'Перевозчик:',
    settings: 'Настройки',
    ...
    'timetable-valid-till': 'Расписание действует до:',
    'timetable-valid-from': 'Расписание действует начиная с:',
    timetables: 'Расписание',
    'to-stop': 'До остановки',
    today: 'Сегодня',
    tomorrow: 'Завтра',
    'train-lines': 'Железнодорожные линии',
    tram: 'Tрамвай',
